(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b1d6b5._.js", {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire("Failed to login", message.message, "error");
            } else {
                router.push("/auth/otp");
            }
        } catch (error) {
            if (error instanceof Error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire("Failed to login", error.message, "error");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire("Failed to login", "An unknown error occurred", "error");
            }
        } finally{
...
_s(LoginForm, "3/yWN9ArlebwEw9hOn/BYAcpERE=", false, function() {
    return [
...
//# sourceMappingURL=src_b1d6b5._.js.map