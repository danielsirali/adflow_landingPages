...
export default function MainNav() {
  ...
  return (
    <nav className="flex justify-between items-center px-6 relative z-10">
      ...
      <div className="flex justify-between items-center space-x-10 mr-28 text-black text-md hidden md:flex">
        <div className="flex space-x-16">
          ...
          <Link href="/how-it-works" className="hover:text-black text-black">
            How it Works
          </Link>
          <Link href="/contact-us" className="hover:text-black text-black">
            Contact Us
          </Link>
        </div>
