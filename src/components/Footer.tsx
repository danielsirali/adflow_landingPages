...
export default function Nav() {
  return (
    <footer className="relative bg-white py-18 mt-16 px-6 md:px-16 lg:px-32">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row justify-between items-start relative">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-10 mt-6 md:mt-0">
          <div>
